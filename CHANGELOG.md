...
### Fixed
- WebSocket `Upgrader` now echoes `Sec-WebSocket-Protocol` header back during upgrade when the server accepts a sub-protocol, fixing RFC 6455 §4.2.2 compliance and preventing browser-side EOF errors.
